...
(function() {
  // Atlas Chat Widget v8.3 (Fixed Bubble Width with w-fit)
  console.log("Atlas Chat Widget v8.3 Loaded");
  ...
  function initWidget() {
    ...
    // C. Constants
    const logoUrl = 'https://static.wixstatic.com/shapes/de1bc2_835a4a0ca8ec492f8c43e18886b48074.svg';
    ...
    widgetContainer.innerHTML = `
        <!-- Launcher -->
        <button id="atlas-launcher" style="${launcherStyles}" class="fixed bottom-6 right-6 w-14 h-14 rounded-full bg-gradient-to-t from-[#0E1013] to-[#2A2A32] text-white shadow-lg flex items-center justify-center border border-white/20 hover:scale-105 hover:bg-onyx-light z-[99999] transition-all duration-500 atlas-spring">
    ...
    const renderHeader = () => {
        ...
        const titleText = isChat ? 'Asystent AI' : 'Historia';
    ...
    const renderMessages = () => {
        ...
        session.messages.forEach(msg => {
            ...
            div.innerHTML = `
                ${avatarHtml}
                <div class="relative max-w-[85%] sm:max-w-[80%] w-fit px-4 py-3 sm:px-5 sm:py-3.5 text-[15px] sm:text-sm leading-relaxed break-words shadow-sm ${bubbleClass}">
